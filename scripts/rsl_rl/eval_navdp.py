...
parser.add_argument(
    "--max_angular_speed", type=float, default=0.5)
parser.add_argument(
...
from navol.paths import policy_checkpoint_path
...
def main():
    ...
    env_cfg.actions.joint_combined.max_angular_speed = args_cli.max_angular_speed
