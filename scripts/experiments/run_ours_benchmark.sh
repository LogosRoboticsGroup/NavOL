...
CUDA_VISIBLE_DEVICES=0 python scripts/rsl_rl/eval_navdp.py --headless --task pointgoal_eval_distillation \
    ...
    --checkpoint_path logs/rsl_rl/dingo_pointgoal_distillation/2025-11-15_23-15-11_scene50_step128_mpc/model_500_navdp.pt \
    --scene_dir source/scene_data_benchmark_scenes_in_domain/benchmark_in_domain \
    --save_path results/full_1116_step128 --use_mpc --extra step128_mpc_mpc_500
...
CUDA_VISIBLE_DEVICES=0 python scripts/rsl_rl/eval_navdp.py --headless --task pointgoal_eval_distillation \
    --num_envs 10 --scene_scale 1.0 --scene_index 0 --save \
    --checkpoint_path logs/rsl_rl/dingo_pointgoal_distillation/2026-03-29_09-29-29_scene50_step128_repeat2/model_100_navdp.pt \
    --scene_dir source/scene_data_benchmark_scenes_out_domain/benchmark_out_domain \
    --save_path results/ablation_repeat2 --use_mpc
