...
CUDA_VISIBLE_DEVICES=0 python scripts/rsl_rl/eval_navdp.py --headless --task pointgoal_eval_distillation \
    ...
    --checkpoint_path logs/rsl_rl/dingo_pointgoal_distillation/2025-11-10_16-01-42_sim50_CamRand_ep10_step8_env32_lr1e-5_command_r0.25_scale1_critic0.1_search0.1/model_2000_navdp.pt \
    --scene_dir source/scene_data_benchmark_scenes_in_domain/benchmark_in_domain \
    --save_path results/ablation_wo_critic --wo_critic --use_mpc --extra mpc
