...
import navol.tasks.manager_based.navol.mdp as mdp
import navol.terrains as terrain_gen
...
from navol.assets import UNITREE_GO2_CFG  # isort: skip
        ...
        rigid_objects={
            "object": RigidObjectCfg(
                ...
                spawn=sim_utils.UsdFileCfg(
                    usd_path="./source/scene_data/scene.usd",
    ...
    cone_red: RigidObjectCollectionCfg = RigidObjectCollectionCfg(
        rigid_objects={
            "cone_red": RigidObjectCfg(
                ...
                spawn=sim_utils.UsdFileCfg(
                    usd_path="./source/scene_data/red.usd",
                    rigid_props=sim_utils.RigidBodyPropertiesCfg(kinematic_enabled=True, disable_gravity=True),
                    mass_props=sim_utils.MassPropertiesCfg(mass=1.0),
                    collision_props=sim_utils.CollisionPropertiesCfg(collision_enabled=True),
                ),
    ...
    cone_green: RigidObjectCollectionCfg = RigidObjectCollectionCfg(
        rigid_objects={
            "cone_green": RigidObjectCfg(
                ...
                spawn=sim_utils.UsdFileCfg(
                    usd_path="./source/scene_data/green.usd",
                    rigid_props=sim_utils.RigidBodyPropertiesCfg(kinematic_enabled=True, disable_gravity=True),
                    mass_props=sim_utils.MassPropertiesCfg(mass=1.0),
                    collision_props=sim_utils.CollisionPropertiesCfg(collision_enabled=True),
                ),
    ...
    cone_blue: RigidObjectCollectionCfg = RigidObjectCollectionCfg(
        rigid_objects={
            "cone_blue": RigidObjectCfg(
                ...
                spawn=sim_utils.UsdFileCfg(
                    usd_path="./source/scene_data/blue.usd",
                    rigid_props=sim_utils.RigidBodyPropertiesCfg(kinematic_enabled=True, disable_gravity=True),
                    mass_props=sim_utils.MassPropertiesCfg(mass=1.0),
                    collision_props=sim_utils.CollisionPropertiesCfg(collision_enabled=True),
                ),
...
class ActionsCfg:
    ...
    joint_pos = mdp.VelocityCommandActionCfg(
        ...
        policy_dir="ckpt/model.pt",
        uplevel_frequency=UPLEVEL_FREQUENCY,
        mesh_path="ckpt/combined2.ply",  
        debug_vis=True,
    )
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        gs_image = mdp.GSImageFeatureCfg(
...
class RewardsCfg:
    ...
    track_predict_velocity_command = RewTerm(
        func=mdp.track_predict_velocity_command, weight=0.2, params={"action_name": "joint_pos", "std": math.sqrt(0.25)}
    )
...
class UnitreeGo2GSBaseEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: MySceneCfg = MySceneCfg(num_envs=64, env_spacing=8)
    # Basic settings
