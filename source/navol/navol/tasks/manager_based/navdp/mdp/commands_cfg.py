...
from .commands import TaskCommand, UniformVelocityCommandStanding
...
@configclass
class TaskCommandCfg(CommandTermCfg):
    """Configuration for the uniform velocity command generator."""

    class_type: type = TaskCommand
    task_prob: list = [0.5, 0.0, 0.5, 0.0] # point image nogoal pixel    (maybe point_image?)
